   ...
   public class D_Cliente
    {
        ...
        public void Actualizar_Cliente(CLIENTES obj)
        {
            using (var db = new BD_JSYSEntities())
            {
                ...
                obj_cliente.DIRECCION_REFERENCIA3 = obj.DIRECCION_REFERENCIA3;
                ...
                obj_cliente.NOMBRE_REFERENCIA3 = obj.NOMBRE_REFERENCIA3;
                obj_cliente.NUMERO_IDENTIFICACION = obj.NUMERO_IDENTIFICACION;
                obj_cliente.REFERENCIA = obj.REFERENCIA;
                ...
                obj_cliente.TELEFONO_REFERENCIA3 = obj.TELEFONO_REFERENCIA3;
                db.SaveChanges();
            }
        }
    }
