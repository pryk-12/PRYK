...
namespace JSYS.Formularios
{
    public partial class Frm_Cliente : JSYS.Formularios.Frm_Plantilla
    {
        ...
        public void Recibir_Datos(CLIENTES obj)
        {
            ...
            {
                var obj_cliente = db.CLIENTES.Find(obj.ID_CLIENTE);
                Txt_ID.Text = obj_cliente.ID_CLIENTE.ToString();
                ...
                txt_direccion_referencia3.Text = obj_cliente.DIRECCION_REFERENCIA3;
                ...
                txt_nombre_referencia3.Text = obj_cliente.NOMBRE_REFERENCIA3;
                ...
                txt_telefono_referencia3.Text = obj_cliente.TELEFONO_REFERENCIA3;
        ...
        public void Insertar()
        {
            ...
            obj.DIRECCION_REFERENCIA3 = txt_direccion_referencia3.Text.Trim();
            ...
            obj.NOMBRE_REFERENCIA3 = txt_nombre_referencia3.Text.Trim();
            ...
            obj.TELEFONO_REFERENCIA3 = txt_telefono_referencia3.Text == "   -   -" ? "" : txt_telefono_referencia3.Text.Trim();
            try
            {
                ...
                {
                    obj.ID_CLIENTE = Convert.ToInt32(Txt_ID.Text);
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (!txt_telefono_referencia3.Text.Equals("   -   -"))
            {
                if (txt_telefono_referencia3.Text.Length < 12)
                {
                    S_Utilidades.Mensaje_Informacion("El Número de Teléfono de la Referencia 3 Esta Incompleto");
                    txt_telefono_referencia3.Focus();
                    return;
                }
            }
            Insertar();
